...
liệu, lưu lượng và team size chưa đủ để biện minh cho chi phí vận hành
của kiến trúc microservice đầy đủ.

\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.9\textwidth]{graphics/overall.png}
    \caption{Luồng cấp lại mã truy cập}
...
pattern. Chi tiết được trình bày tại Chương~\ref{chap:auth}.
...
bày tại Chương~\ref{chap:backup}.
